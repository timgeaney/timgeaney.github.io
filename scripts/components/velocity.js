    ...
    var introAnimation = function() {
        ...
        if (currentScrollTop > 5 || (isInitialTouchScroll)) {
            ...
            if (!introAnimationRun)
            {
                ...
                {
                    $('div.header-img').velocity({ translateY: "-60%", opacity: 0, scale: 0.8 }, { duration: 800, queue: false, easing: [0.7,0,0.3,1] });
                ...
                $('article.velocity').velocity({ translateY: "0px", opacity: 1 }, { duration: 575, queue: false, delay: 200, easing: "ease-in-out",
                complete: function() {                     
        ...
        // if we have moved back to the top
            ...
            if (introAnimationRun)
            {
                ...
                $('article.velocity').velocity({ translateY: "0px", opacity: 0 }, { duration: 400, queue: false, easing: "ease-out" });
